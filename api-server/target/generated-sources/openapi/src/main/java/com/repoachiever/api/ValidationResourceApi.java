...
public interface ValidationResourceApi {
    ...
    ValidationSecretsApplicationResult v1SecretsAcquirePost(@Valid @NotNull ValidationSecretsApplication validationSecretsApplication);
}
